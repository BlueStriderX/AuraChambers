...
import thederpgamer.aurachambers.utils.DataUtils;
import thederpgamer.aurachambers.utils.DateUtils;
...
public class LogManager {
    ...
    private static void logMessage(MessageType messageType, String message) {
        if(!messageQueue.contains(message) || messageType.equals(MessageType.CRITICAL)) {
            String prefix = "[" + DateUtils.getTimeFormatted() + "] [AuraChambers] " + messageType.prefix;
            try {
                ...
                DebugFile.log(builder.toString(), AuraChambers.getInstance());
