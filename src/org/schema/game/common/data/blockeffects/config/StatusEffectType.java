...
public enum StatusEffectType {
    ...
    //Defensive Auras
    SHIELD_TRANSFER_AURA(StatusEffectCategory.AURA, new Object() {
        @Override
        public final String toString() {
            return "Shield Transfer Aura";
        }//        Transfer Amount               Maximum Targets
    }, true, StatusEffectFloatValue.class, StatusEffectIntValue.class)
    //
    ;
    ///
